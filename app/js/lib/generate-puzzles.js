...
var generatePuzzles = function (styles, styleNames, boardSize, startId) {
	'use strict';
	...
	return {
		id: id,
		puzzles: puzzles.slice(0).sort(function (a, b) {
			return a.index - b.index;
		})
	};
};

module.exports = generatePuzzles.bind(this, puzzleStyles, puzzleStyleNames);
